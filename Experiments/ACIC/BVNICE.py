...
folder_ind = (acic_ind//77)+1   # 1-77
file_ind = np.mod(acic_ind,77)    # 0-99



# acic_ind = np.mod(int(sys.argv[1]),7700)   # 77*100 datasets
# param_id = int(sys.argv[1])//7700
# folder_ind = (acic_ind//77)+1   # 1-77
# file_ind = np.mod(acic_ind,77)    # 0-99
...
# X = pd.read_csv('./onlineData/data_cf_all/x.csv')
...
# folder_ind = 1  # 1-77
# folder_dir = './onlineData/data_cf_all/'+str(folder_ind)+'/'
